            ...
            <CardContent>
              {statsLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Compteurs Actifs</span>
                    <span className="font-semibold">{stats?.active_meters || 0}</span>
                  </div>
                </div>
              )}
            </CardContent>
            ...
            <CardContent>
              {statsLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Lectures Aujourd'hui</span>
                    <span className="font-semibold">{stats?.total_readings_today || 0}</span>
                  </div>
                </div>
              )}
            </CardContent>
